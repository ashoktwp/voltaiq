        ...
        return (
          ...
          $.isFunction(b.showFunction) &&
            ...
            $(window).outerHeight() +
              ...
              b.showShift >
              $(this).offset().top +
                (b.wholeVisible ? $(this).outerHeight() : 0) &&
            $("#scrollzipPoint").offset().top +
              (b.wholeVisible ? $(this).outerHeight() : 0) <
              $(this).outerHeight() + $(this).offset().top - b.showShift &&
            ($(this).addClass("isShown"), b.showFunction.call(this)),
          $.isFunction(b.hideFunction) &&
            $(this).hasClass("isShown") &&
            ($(window).outerHeight() +
              $("#scrollzipPoint").offset().top -
              b.hideShift <
              ...
              $("#scrollzipPoint").offset().top +
                (b.wholeVisible ? $(this).outerHeight() : 0) >
                $(this).outerHeight() + $(this).offset().top - b.hideShift) &&
            ($(this).removeClass("isShown"), b.hideFunction.call(this)),
          this
        );
      });
    });
